<template>
  <UPageCard to="https://ui.nuxt.com/pro?utm_source=nuxt_tailwind_website&utm_medium=banner" target="_blank" :ui="{ header: { padding: 'p-0 sm:p-0' }, rounded: 'rounded', body: { padding: 'p-2 sm:p-2', base: 'text-center' } }">
    <template #header>
      <svg
        viewBox="0 0 167 96"
        fill="none"
      ...
      >
        ...
        <defs>
          ...
          >
            ...
            <feGaussianBlur in="BackgroundImageFix" stdDeviation="3.84743" />
            <feComposite
              in2="SourceAlpha"
              operator="in"
