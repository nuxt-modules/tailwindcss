...
To make use of this in your config you can rename your `tailwind.config.js` to `tailwind.config.ts` and use the types directly from the tailwindcss module like so:
