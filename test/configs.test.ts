...
describe('tailwindcss module configs', async () => {
  ...
  test('throws error about malformed config', () => {
    // TODO: investigate warning (possibly generated by loading tailwind.config?)
    // ERROR  (node:19395) Warning: To load an ES module, set "type": "module"
    // in the package.json or use the .mjs extension.
    const output = spyStderr.mock.calls.map(m => m[0].toString())
      .filter(o => !o.includes('To load an ES module'))
